...
void main() {
  ...
  group('ContextManager overflow integration', () {
    test('Agent retries once on ContextOverflowException', () async {
      ...
      final core = Agent(llm: llm, tools: {});
    ...
    test('Agent does not retry a second time on repeated overflow', () async {
