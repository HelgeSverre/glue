...
///
/// Provider resolution and concrete client construction belong at the provider
/// boundary rather than in the transport/protocol package.
class LlmClientFactory {
  ...
  ///
  /// Throws [ConfigError] when the provider is unknown or the adapter has not
  /// been registered.
