...
// TODO: replace with config file grouped by category, add convenience getter/setter to access by dot notation like "llm.ollama.base_url" and "agent.bash.max_lines_default", "ui.at_file_hint.max_tree_entries", etc.
...
class AppConstants {
  ...
  // Agent configuration (agent.subagent.*)
  ...
  // Web tool configuration (tool.web_fetch   , tool.web_search)
  ...
  // Browser tool configuration (web.browser).*
