...
enum ToolTrust {
  ...
  /// Tools that create or modify files. Auto-approved in acceptEdits mode.
  fileEdit,

  /// Tools that execute arbitrary shell commands. Only auto-approved in
  /// ignorePermissions mode.
  command,
}
