...
/// regex, and generates:
///   1. One `.md` file per source file in `../website/api/{module}/`
///   2. `../website/.vitepress/sidebar.json` for VitePress sidebar
///   3. `../website/api/index.md` — API landing page
///
/// Usage:
///   dart run tool/generate_website_api.dart
library;
