...
void main() {
  group('ModalExecutor.runCapture', () {
    ...
    test('startStreaming returns a handle that emits stream_data + exits',
        () async {
      final sidecar = FakeModalSidecar()
        ..streamScripts.add((
          stdout: ['line_1\n', 'line_2\n'],
      ...
      final handle =
          await executor.startStreaming('echo line_1 && echo line_2');
    ...
    test('streaming handle kill is best-effort + still resolves exitCode',
        () async {
      final sidecar = FakeModalSidecar()
