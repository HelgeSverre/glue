...
void main() {
  ...
  group('sessionEventToAcpUpdate', () {
    ...
    test('runtime lifecycle events return null (reserved for future)', () {
      // All seven runtime-lifecycle variants are defined in glue_core
      // but not yet routed through ACP (parallel to how MCP lifecycle
