...
When Glue talks to Ollama, the `/model` picker should reflect the user's _actual_ installed models — merged with the curated catalog — instead of showing only curated rows that may or may not be pulled locally.
