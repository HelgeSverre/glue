...
Make `conversation.jsonl` the durable local event log for sessions, replay, debugging, and lightweight observability — replacing the need for OpenTelemetry/Langfuse as the _default_ local debugging path.
