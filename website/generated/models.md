...
| `anthropic/claude-sonnet-4-7` | ★ | chat, tools, vision, files, json, reasoning, coding | 200000 | standard | high | Latest Sonnet model available for selection. |
| `anthropic/claude-opus-4-7` | ★ | chat, tools, vision, files, json, reasoning, coding | 200000 | slower | premium | Latest Opus model available for selection. |
...
| `copilot/claude-sonnet-4-6` | ★ | chat, tools, vision, json, coding | 200000 | standard | subscription | Uses your GitHub Copilot subscription. |
