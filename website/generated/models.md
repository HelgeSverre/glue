...
| `openrouter/anthropic/claude-sonnet-4-6` | ★ | chat, tools, vision, files, json, reasoning, coding | 1000000 | standard | provider_routed | Useful when users want one router key. |
